<script lang="ts">
	import { addLinkMode, newLink, currentFolder } from '../../stores/stores';
...
<div class="add_link_form_wrapper" on:click|preventDefault|stopPropagation={exitAddLinkMode}>
	<form on:click|stopPropagation|preventDefault>
		<div class="top">
			<span>Add Link</span>
