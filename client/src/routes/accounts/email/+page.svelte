<script lang="ts">
	...
	import { email_exists, user } from '../../../stores/stores';
...
<div class="content">
	...
	<form>
		...
		<div class="sign_in_instead">
			<span class="sign_up_heading" on:click|preventDefault|stopPropagation={signinInstead} on:keyup
				>Already have an account? Sign in to your account</span
			>
		</div>
	</form>
</div>
