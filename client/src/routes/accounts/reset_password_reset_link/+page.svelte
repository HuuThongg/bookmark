...
<div class="wrapper">
	<div>{emailIsInvalid}</div>
	<form action="">
		<div class="top">
			<h4>Request password reset link</h4>
			<p>Please enter the email address you'd like your password reset information</p>
		</div>
		...
		<div class="bottom">
			...
			<a href={`${$page.url}/accounts/sign_in`}>GO back to login page</a>
		</div>
	</form>
</div>
